                  ...
                  <Styles>
                      <Row className="Row1 justify-content-center" >
                          ...
                          <Col className="try" md={4} sm={6} >
                                  ...
                                  <Col className="Lower">
                                        <img src={darij} className="im1" />
                                        <Col className="info">
                                            <h5 className="name">Syed Darij Ali</h5>
                                            <p className="pos"> Head Ui Design </p>
                                        </Col>
                                  </Col>
                          ...
                          <Col className="try" md={4} sm={6} >
                                  ...
                                  <Col className="Lower">
                                        <img src={noor} className="im1" />
                                        <Col className="info">
                                            <h5 className="name">Noor Muhammad</h5>
                                            <p className="pos"> Head Database </p>
                                        </Col>
                                  </Col>
                          ...
                          <Col className="try" md={4} sm={6} >
                                  ...
                                  <Col className="Lower">
                                        <img src={usama} className="im1" />
                                        <Col className="info">
                                            <h5 className="name">Usama Imran</h5>
                                            <p className="pos"> Head Website </p>
                                        </Col>
                                  </Col>
